...
public class PlayerStats : MonoBehaviour {
	public Stats stats = new Stats(1, 600, 4, 2, 3); //Объявляем новый объект Stats
...
//		}
	...
	void OnGUI()
	{
		if(showstat == 1) //если статы отображаются
		{
			...
			GUI.Label (new Rect(10, 230,300,300), "minDamage: "+(int)stats.MinDamage);
			GUI.Label (new Rect(10, 245,300,300), "maxDamage: "+(int)stats.MaxDamage);
